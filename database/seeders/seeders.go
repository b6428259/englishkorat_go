	...
	students := []models.Student{
		{
			...
			AgeGroup:             "adults",
			CEFRLevel:            "B1",
			GrammarScore:         func(i int) *int { return &i }(75),
			SpeakingScore:        func(i int) *int { return &i }(70),
			ListeningScore:       func(i int) *int { return &i }(80),
			ReadingScore:         func(i int) *int { return &i }(77),
			WritingScore:         func(i int) *int { return &i }(75),
